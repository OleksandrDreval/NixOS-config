...

{
  ...
  console = { 
    ...
    colors      = theme.colors16;  # Використання theme.colors16 палітри кольорів для консолі, що дозволяє зберегти узгоджену колірну схему з іншими елементами системи.
  };
