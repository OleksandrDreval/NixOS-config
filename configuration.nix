...

{
  ...
  boot = {
    ...
    kernel.sysctl = {
      ...
      "net.ipv4.ip_forward"                         = "0";  # Вимкнення IP forwarding для запобігання використання як маршрутизатора. Зменшує ризик MITM атак.
      ...
      "net.ipv6.conf.default.forwarding"            = "0";  # Вимкнення IPv6 forwarding за замовчуванням. Додатковий захист для IPv6.
      ...
      "net.ipv6.icmp_echo_ignore_all"               = "1";  # Ігнорування всіх ICMP echo запитів (ping). Запобігає DoS атакам через ping.
      ...
      "net.ipv4.conf.all.arp_ignore"                = "1";  # Налаштування ARP ignore для всіх інтерфейсів. Додатковий захист від ARP атак.
